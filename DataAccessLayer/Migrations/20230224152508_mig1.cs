            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    QuoteID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    QuoteDate = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    QuoteDesc = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    QuotePrice = table.Column<double>(type: "float", nullable: false),
